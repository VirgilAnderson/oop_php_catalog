      ...
      <div class="listing_details">
        ...
        <div class='listing_footer'>
          <ul class='footer_menu'>
            <li><a href='<?php echo url_for('/user/registration/edit.php'); ?>'>Forgot my Password</a></li>
            <li><a href='<?php echo url_for('/user/registration/delete.php'); ?>'>Create Account</a></li>
          </ul>
        </div><!-- listing_footer -->
      </div><!-- listing_details -->
  </article>
